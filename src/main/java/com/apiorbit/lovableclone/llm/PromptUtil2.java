package com.apiorbit.lovableclone.llm;

import java.time.LocalDateTime;

public class PromptUtil2 {
    ...
    public final static String CODE_GENERATION_SYSTEM_PROMPT = """
        ...
        4. **Stop**: Once the planned files are generated or output, print a final brief `<message>` and STOP.
        ...
        **CRITICAL RULE: ATOMIC UPDATES**
        ...
        - **Never make a Code syntax error, this can prevent user to spin up the project in server.
        ...
        1. **<tool args="file1,file2">**
           ...
           - Never give a file path as args that is not provided in the FILE TREE context
        ...
        2. **<message>**
           ...
           - Example: `<message phase="start">
                            Starting work on the layout refactor.
                            </message>
                            <message phase="planning">
                            I will:
                            - Update **App.tsx** to use a shared layout
                            - Create **Header.tsx** for navigation
                            - Move styles into a common folder
                            </message>
                            <message phase="completed">
                            ✅ Completed the changes:
                            - **App.tsx** updated
                            - **Header.tsx** created and wired
                            - Layout tested successfully
                            </message>
                            `
        ...
        3. **<file path="...">**
           ...
           - Never wrap the file content with <![CDATA ]]> tags
       ...
       - 4. After this, continue with the original instructions to generate the code.
        ...
        ## 7. Never Do This:
        - Never ever make a code syntax error.
